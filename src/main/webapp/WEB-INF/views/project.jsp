...
//                    "scrollY": 400,
                ...
                function getAllCompany() {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            var collaboration;
                            collaboration += '<option value="0">Select Company</option>';
                ...
                function initializeProjectForm() {
                    ...
                    $("#version").val("");
                    $("#name").val("");
//                    $("#listOfCompany option:selected").prop('selected' , false);
//                    $('#listOfCompany select option[value=""]').prop('selected',true);
                    $("#listOfCompany option:first").attr('selected','selected');
//                    $("#listOfCompany option[text='Select Company']").attr("selected","selected");
                }
